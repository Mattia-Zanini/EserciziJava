...
public class BombLab2 {
   ...
   public static int first(int n) {
      int result = n - 10 + 3 * 2;
      // System.out.println("Questo è il risultato: " + result);
      return result;
   }

   // Secondo stadio
   public static int second(int n) {
      // System.out.println("Questo è il valore di n: " + n);
      // System.out.println("Questo è il valore di n/10: " + n / 10);
      // System.out.println("Questo è il valore di n%10: " + n % 10);
   ...
   public static int third(int n) {
      ...
      int result = n % 10;// 0
      n = n / 10; // 210184
      result = result + n % 10; // 4
      n = n / 10; // 21018
      result = result + n % 10; // 12
      n = n / 10;// 2101
      result = result + n % 10; // 13
      n = n / 10;// 210
      result = result + n % 10; // 13
      n = n / 10; // 21
      result = result + n % 10; // 14
